...
const create_music = async (name, artists, album, release_date, genres, description) => {
    try {
...
const update_music = async (id, name, artists, album, release_date, genres, description) => {
    try {
